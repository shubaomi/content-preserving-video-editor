...
IMPLEMENTATION_PATHS = (
    ...
    Path("scripts/delivery_readiness.py"),
    Path("scripts/capability_registry.py"),
    Path("scripts/production_contract.py"),
    Path("scripts/completion_audit.py"),
    ...
    Path("scripts/review_dashboard.py"),
    Path("scripts/creative_review.py"),
    ...
    Path("scripts/keyframe_receipt.py"),
    Path("scripts/renderer_project_manifest.py"),
    Path("scripts/preview_render_parity.py"),
    Path("scripts/build_motion_snapshot_plan.py"),
    Path("references/motion-recipes-v1.json"),
)
