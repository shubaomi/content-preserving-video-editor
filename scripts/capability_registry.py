...
_REGISTRY = (
    ...
    _capability("jianying_native_draft_v1", "human-editor",
                dependencies=["video_use_timeline", "manual_nle_package_v2"],
                inputs=["current_nle_package", "authoritative_edl", "master_srt",
                        "layer_timeline", "exact_asset_hashes"],
                outputs=["jianying-draft-plan.json", "draft-status.json",
                         "install-proposal.json", "synthetic_fixture_package",
                         "isolated_test_install_receipt",
                         "exact_test_rollback_receipt"],
                maturity="fixture_validated",
                failure_fallback="preserve_automatic_master_and_editor_neutral_package",
                compatibility="pyjianyingdraft_0_3_fixture_only"),
