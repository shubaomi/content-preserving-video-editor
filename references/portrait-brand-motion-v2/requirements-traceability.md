...
| PBM-RQ-019 | Direct protection by current meaning | Product-focused windows keep the product and captions hard-protected while allowing at most one bounded face/hand region ID near the product; current semantic/Storyboard authority supplies focus and duration, and post-exit geometry proves restoration | Treating all body overlap as forbidden or allowing renderer-self-authorized face coverage | semantic brief + Storyboard + geometry gate | made-up focus, two-hand, stale-window, missing-exit, overlap/proximity and hard-zone negative tests |
| PBM-RQ-020 | Give captions a restrained brand voice | Phrase text/timing stay source-identical while up to two approved matching anchors receive bounded color, weight, and scale emphasis | Rainbow captions, every-word animation, per-character flashing, or invented copy | caption system + Director FFmpeg | ASS/plan hashes, SRT authority, anchor-match and configuration-bound tests |
